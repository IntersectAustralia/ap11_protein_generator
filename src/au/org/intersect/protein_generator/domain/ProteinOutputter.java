...
public class ProteinOutputter implements Outputter
{
    ...
    public ProteinOutputter(ProteinLocation proteinLocation, String databaseName, StringBuilder genomeString, CodonTranslationTable translationTable)
    {
    ...
    public String getOutput() throws OutputException
    {
        ...
        {
            aminoAcidSequence = translationTable.proteinToAminoAcidSequence(sequence.toString());
        }
        ...
        {
            buffer.append(aminoAcidSequence.substring(sequenceCursor, sequenceCursor + FASTA_LINE_LENGTH));
            buffer.append(lineFeed);
            sequenceCursor += FASTA_LINE_LENGTH;
        }
        if (sequenceCursor < sequenceLength)
        {
            buffer.append(aminoAcidSequence.substring(sequenceCursor, sequenceLength));
            buffer.append(lineFeed);
        }
